...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "router-2" do |router2|
    ...
    router2.vm.provision "shell", path: "shell_scripts/router-2.sh"
  ...
  config.vm.define "switch" do |switch|
    ...
    switch.vm.provision "shell", path: "shell_scripts/switch.sh"
  ...
  config.vm.define "host-a" do |hosta|
    ...
    hosta.vm.provision "shell", path: "shell_scripts/host-a.sh"
  ...
  config.vm.define "host-b" do |hostb|
    ...
    hostb.vm.provision "shell", path: "shell_scripts/host-b.sh"
